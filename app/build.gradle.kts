...
tasks.register("androidTestClasses") {
    group       = "build"
    description = "AGP-9 compatibility alias for legacy IDE instrumented-test runners."
    dependsOn(
        tasks.named("compileDebugAndroidTestKotlin"),
        tasks.named("processDebugAndroidTestJavaRes"),
    )
}
