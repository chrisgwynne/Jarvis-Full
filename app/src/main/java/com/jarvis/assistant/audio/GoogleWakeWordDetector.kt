        ...
        handler.post {
            ...
            r.startListening(
                Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH).apply {
                    ...
                    // Cloud model is significantly more sensitive for quiet
                    // "Jarvis" at normal speaking volume.  The on-device model
                    // requires louder-than-normal activation — this was the root
                    // cause of "needs shouting to wake".  Allow cloud when online.
